# Ghosthand-J API Quick Reference

This file is a compact route reference for the Ghosthand-J skill.
...
- `GET /commands` — machine-readable Ghosthand-J capability catalog
...
- Capability use depends on both system authorization and Ghosthand-J policy.
